...
long ServerDataCommunication::UnInit()
{
	TSDEBUG(L"Enter");
	...
	lpPerHandleData->Socket = m_localSocket;
	...
	::PostQueuedCompletionStatus(m_hIoCompletionPort, 0, (DWORD)lpPerHandleData, &(lpPerIoOperationData->Overlapped));
