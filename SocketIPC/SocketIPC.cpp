...
long SIPC_StreamWriteBytes(SIPC_STREAM hSIpcStream, const BYTE* lpBytes, int iLen)
{
	...
	LPSOCKETIPC_STREAM lpSocketIpcStream = (LPSOCKETIPC_STREAM)hSIpcStream;
	return CommonTool::StreamWriteBytes(lpSocketIpcStream, lpBytes, iLen);
}
...
long SIPC_StreamWriteWString(SIPC_STREAM hSIpcStream, const wchar_t* wszData)
{
	...
	LPSOCKETIPC_STREAM lpSocketIpcStream = (LPSOCKETIPC_STREAM)hSIpcStream;
	return CommonTool::StreamWriteWString(lpSocketIpcStream, wszData);
}
...
long SIPC_StreamReadBytes(SIPC_STREAM hSIpcStream, BYTE* lpBytes, int iLen)
{
	...
	LPSOCKETIPC_STREAM lpSocketIpcStream = (LPSOCKETIPC_STREAM)hSIpcStream;
	return CommonTool::StreamReadBytes(lpSocketIpcStream, lpBytes, iLen);
}
...
long SIPC_StreamReadWString(SIPC_STREAM hSIpcStream, wchar_t* wszData, int iLen)
{
	...
	LPSOCKETIPC_STREAM lpSocketIpcStream = (LPSOCKETIPC_STREAM)hSIpcStream;
	return CommonTool::StreamReadWString(lpSocketIpcStream, wszData, iLen);
}
